...
VegData = dataImport('/Users/isamarcortes/Dropbox/Isamar/Papers_In_Prep/Paper_4/RasterLayersForLandlab/PR5_Paper4.tif')
...
#sal_values = 40
sal_values = outerEdgeSalinity(40,40,salinity)###change based on whether inner or outer bay island
salinity[:]=sal_values
...
D =difussionOuterBay(-1,sal_array,14.46437818,14.46437818)
...
with rio.open('/Users/isamarcortes/Downloads/PR_NDVI_Islands/PR5_NDVI.tif') as src:
    # Read first band
    NDVI = src.read(1)
