...
VegData = dataImport('/Users/isamarcortes/Dropbox/Isamar/Papers_In_Prep/Paper_4/RasterLayersForLandlab/PR12_Paper4.tif')
...
D =difussionOuterBay(-0.4,sal_array,20,10)
...
with rio.open('/Users/isamarcortes/Downloads/PR_NDVI_Islands/PR12_NDVI.tif') as src:
    # Read first band
    NDVI = src.read(1)
