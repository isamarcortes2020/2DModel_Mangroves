...
VegData = dataImport('/Users/isamarcortes/Dropbox/Isamar/Papers_In_Prep/Paper_4/RasterLayersForLandlab/PR7_Paper4.tif')
...
D =difussionOuterBay(-1,sal_array,25,5)
...
with rio.open('/Users/isamarcortes/Downloads/PR_NDVI_Islands/PR7_NDVI.tif') as src:
    # Read first band
    NDVI = src.read(1)
