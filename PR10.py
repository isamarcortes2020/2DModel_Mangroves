...
VegData = dataImport('/Users/isamarcortes/Dropbox/Isamar/Papers_In_Prep/Paper_4/RasterLayersForLandlab/PR10_Paper4.tif')
...
with rio.open('/Users/isamarcortes/Downloads/PR_NDVI_Islands/PR10_NDVI.tif') as src:
    # Read first band
    NDVI = src.read(1)
