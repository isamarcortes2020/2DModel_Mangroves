...
VegData = dataImport('/Users/isamarcortes/Dropbox/Isamar/Papers_In_Prep/Paper_4/RasterLayersForLandlab/PR11_Paper4.tif')
...
D =difussionOuterBay(-1,sal_array,25,20)
...
with rio.open('/Users/isamarcortes/Downloads/PR_NDVI_Islands/PR11_NDVI.tif') as src:
    # Read first band
    NDVI = src.read(1)
